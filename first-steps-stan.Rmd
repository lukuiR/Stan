...
6. Evaluate results. If <span style="color: red;">!!! SAD FACE !!!</span> return to 2.
...
CAN WE MAKE BACKGROUND FOR WARMUP DARKER?
...
The 1x payout is triggered once in every `r format(1 / rtp_summary[1, 1], digits = 0)` spins.

The 100x payout is only triggered once in every `r format(1 / rtp_summary[6, 1], digits = 3)` spins.
...
CAN GET A GIF FOR RTP > 1??? Like "WINNING!"
